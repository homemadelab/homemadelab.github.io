...
const respuesta1 = document.getElementById("respuesta1");//.style.display = 'none';
const respuesta2 = document.getElementById("respuesta2");//.style.display = 'none';
const respuesta3 = document.getElementById("respuesta3");//.style.display = 'none';
const respuesta4 = document.getElementById("respuesta4");//.style.display = 'none';
  ...
  if (i == 100) {
    ...
    function frame() {
      if (width <= 0) {
        clearInterval(id);
        i = 100;
        window.location.href = "/en/tiempoAcabado.html";
      } else {
        width--;
...
async function obtenerArchivo() {
  const archivo = await fetch("preguntas_en.csv"); // Recibo el archivo con las preguntas y respuestas
...
function aleatorizarRepuestas(array) {
...
function aleatorizarRespuestas2(cantRespuestas /*(j)*/) {
